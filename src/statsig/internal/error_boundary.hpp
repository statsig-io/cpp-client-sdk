...
namespace statsig::internal
{
  ...
  private:
        ...
        const std::optional<std::unordered_map<std::string, std::string>> &extra)
    {
      ...
      switch (code)
      {
      case JsonFailureInitializeRequestArgs:
        return "JsonFailureInitializeRequestArgs";
      case JsonFailureInitializeResponse:
        return "JsonFailureInitializeResponse";
      case JsonFailureLogEventResponse:
        return "JsonFailureLogEventResponse";
      case JsonFailureNoDeserializerFound:
        return "JsonFailureNoDeserializerFound";
      case JsonFailureStatsigUser:
      ...
      case JsonFailureDataAdapterResult:
        return "JsonFailureDataAdapterResult";
      case JsonFailureRetryableEventPayload:
        return "JsonFailureRetryableEventPayload";
      case NetworkFailureBadStatusCode:
        return "NetworkFailureBadStatusCode";
